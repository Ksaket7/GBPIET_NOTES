...
export default function LoginPage() {
  ...
  return (
    <main className="app-page md:pl-8 lg:pl-8">
      <div className="mx-auto grid w-full max-w-5xl gap-6 rounded-[24px] border border-white/70 bg-white/45 p-3 shadow-2xl shadow-slate-500/20 backdrop-blur-2xl sm:rounded-[32px] sm:p-5 md:grid-cols-[minmax(0,1fr)_minmax(320px,420px)] md:p-7">
