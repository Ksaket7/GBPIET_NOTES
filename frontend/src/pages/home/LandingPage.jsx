    ...
    <main className="app-page">
      <div className="app-shell space-y-6">
        <section className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="rounded-[28px] bg-gradient-to-br from-slate-950 to-indigo-700 p-8 text-white">
            <span className="rounded-full bg-white/15 px-3 py-1 text-xs font-semibold">
              GBPIET Notes
            </span>
            <h1 className="mt-6 max-w-2xl font-poppins text-5xl font-semibold leading-tight">
          ...
          <div className="glass-panel p-6">
            ...
            <div className="mt-5 space-y-3">
              {[
                ...
                <div key={title} className="flex gap-3 rounded-3xl bg-white/65 p-4">
